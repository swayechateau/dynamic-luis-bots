...
exports.creds = {
  // Required
  identityMetadata: `https://login.microsoftonline.com/${config.set.tenant}/v2.0/.well-known/openid-configuration`,
  ...
  redirectUrl: `${webhost}/auth/openid/return`,
  ...
  clientSecret: config.set.clientSecret,

  // Required to set to false if you don't want to validate issuer
  validateIssuer: config.set.validateIssuer,
...
exports.destroySessionUrl = `https://login.microsoftonline.com/${config.set.tenant}/oauth2/logout?post_logout_redirect_uri=${webhost}/auth/logout`;