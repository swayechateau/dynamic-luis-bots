...
exports.creds = {
  ...
  redirectUrl: `${host}/auth/openid/return`,
...
exports.destroySessionUrl = `https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=${host}/auth/logout`;
