...
if(config.set.tenant===''){config.set.tenant='common'}
exports.creds = {
  // Required
...
exports.destroySessionUrl = `https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=${webhost}/auth/logout`;
