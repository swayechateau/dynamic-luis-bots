...
exports.creds = {
  ...
  redirectUrl: 'http://localhost/auth/openid/return',
...
exports.destroySessionUrl = 'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=http://localhost/auth/logout';
